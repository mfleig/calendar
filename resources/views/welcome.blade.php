...
<html lang="en">
    <head>
        ...
        <link href='vendor\fullcalendar\fullcalendar-3.1.0/fullcalendar.min.css' rel='stylesheet' />
        <link href='vendor\fullcalendar\fullcalendar-3.1.0/fullcalendar.print.min.css' rel='stylesheet' media='print' />
       ...
       {!! Html::style('vendor/bootstrap/bootstrap-3.3.6/dist/css/bootstrap.min.css') !!}
       {!! Html::style('vendor\fullcalendar\fullcalendar-3.1.0/fullcalendar.min.css') !!}
       {!! Html::style('vendor/bootstrap-material-datetimepicker/bootstrap-material-datetimepicker-gh-pages/css/bootstrap-material-datetimepicker.css') !!}
       {!! Html::style('vendor\bootstrap-colorpicker\css\bootstrap-colorpicker.min.css') !!}
    ...
    {{-- <script src='vendor\fullcalendar\fullcalendar-3.1.0//lib/moment.min.js'></script>
    <script src='vendor\fullcalendar\fullcalendar-3.1.0/lib/jquery.min.js'></script>
    <script src='vendor\fullcalendar\fullcalendar-3.1.0/fullcalendar.min.js'></script> --}}

    {!! Html::script('vendor/jquery.min.js') !!}
    {!! Html::script('vendor/bootstrap/bootstrap-3.3.6/dist/js/bootstrap.min.js') !!}
    {!! Html::script('vendor/fullcalendar/fullcalendar-3.1.0/lib/moment.min.js') !!}
    {!! Html::script('vendor/fullcalendar/fullcalendar-3.1.0/fullcalendar.min.js') !!}
    {!! Html::script('vendor/bootstrap-material-datetimepicker/bootstrap-material-datetimepicker-gh-pages/js/bootstrap-material-datetimepicker.js') !!}
    {!! Html::script('vendor\bootstrap-colorpicker\js\bootstrap-colorpicker.js') !!}
    {!! Html::script('vendor\fullcalendar\fullcalendar-3.1.0\locale\es.js') !!}
